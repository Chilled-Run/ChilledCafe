...
struct constant{
    ...
    let guestSample = GuestPost(postId: "1", userName: "guest", visitCount: 1, context: "안녕하세요 반갑습니다", image: "bearPaw", like: true, likeCount: 1, time: "2022.11.17", comments: [Comment(userName: "visit1", context: "반갑습니다"), Comment(userName: "visit1", context: "너무 좋아요"), Comment(userName: "visit1", context: "저도요")])
