...
struct constant{
    ...
    //-------------------------
    let story = Story2(storyId: UUID(), userName: "guest", visitCount: 1, content: "안녕하세요 반갑습니다", image: "bearPaw", likeCount: 1, creatAt: "2022.11.17")
    
    let storySample = Story(storyId: UUID(), userName: "guest", visitCount: 1, context: "안녕하세요 반갑습니다", image: "bearPaw", like: true, likeCount: 1, time: "2022.11.17", comments: [Comment(commentId: UUID(), userName: "visit1", context: "반갑습니다ㄴㅇ러ㅏㅣㄴ어마리ㅓㄴ러ㅏㄴ어라ㅣㄴ머라ㅣㅓㅇ나ㅓ란미ㅓ라ㅣㅇ너리머라ㅣㄴㅇ머리ㅏㄴ어ㅏ라니머리ㅏㅇ너라ㅣㅁ너라ㅣㅇ넘라ㅣㅓㄴㅁ아리ㅏㄴㅁ얼니마얼"), Comment(commentId: UUID(), userName: "visit1", context: "너무 좋아요"), Comment(commentId: UUID(), userName: "visit1", context: "저도요"), Comment(commentId: UUID(), userName: "visit1", context: "저도요"), Comment(commentId: UUID(), userName: "visit1", context: "저도요"), Comment(commentId: UUID(), userName: "visit1", context: "저도요")])
     
    let storySamples = [Story(storyId: UUID(), userName: "guest", visitCount: 1, context: "안녕하세요 반갑습니다. 카페가 너무 이뻐요", image: "bearPaw", like: true, likeCount: 1, time: "2022.11.17", comments: [Comment(commentId: UUID(), userName: "visit1", context: "반갑습니다"), Comment(commentId: UUID(), userName: "visit1", context: "너무 좋아요"), Comment(commentId: UUID(), userName: "visit1", context: "저도요")]), Story(storyId: UUID(), userName: "guest", visitCount: 1, context: "사장님이 직접 내려주신 커피향이 너무 좋네요", image: "bearPaw", like: true, likeCount: 1, time: "2022.11.17", comments: [Comment(commentId: UUID(), userName: "visit1", context: "반갑습니다"), Comment(commentId: UUID(), userName: "visit1", context: "너무 좋아요"), Comment(commentId: UUID(), userName: "visit1", context: "저도요"), Comment(commentId: UUID(), userName: "visit1", context: "저도요"), Comment(commentId: UUID(), userName: "visit1", context: "저도요"), Comment(commentId: UUID(), userName: "visit1", context: "저도요")]), Story(storyId: UUID(), userName: "guest", visitCount: 1, context: "안녕하세요 반갑습니다", image: "bearPaw", like: true, likeCount: 1, time: "2022.11.17", comments: [Comment(commentId: UUID(), userName: "visit1", context: "반갑습니다"), Comment(commentId: UUID(), userName: "visit1", context: "너무 좋아요"), Comment(commentId: UUID(), userName: "visit1", context: "저도요")]), Story(storyId: UUID(), userName: "guest", visitCount: 1, context: "안녕하세요 반갑습니다", image: "bearPaw", like: true, likeCount: 1, time: "2022.11.17", comments: [Comment(commentId: UUID(), userName: "visit1", context: "반갑습니다"), Comment(commentId: UUID(), userName: "visit1", context: "너무 좋아요"), Comment(commentId: UUID(), userName: "visit1", context: "저도요")])]
    }
