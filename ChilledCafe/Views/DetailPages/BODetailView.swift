...
struct BODetailView: View {
    ...
    @State var time = Timer.publish(every:0.05, on: .current, in: .tracking).autoconnect()
    //캐러셀 밑으로 내려가면 true
        ...
        ZStack {
            ...
            if checkingNavigationBar {
                VStack {
                    ...
                    .padding(EdgeInsets(top: UIScreen.getHeight(47), leading: UIScreen.getWidth(20), bottom: 0, trailing: UIScreen.getWidth(20)))
